(() => {
  ...
  const normalizeMessage = (message) => {
    ...
    if (/no token|missing .*token|login required|please log in|guests? cannot|guest accounts/i.test(text)) return 'Guest accounts can’t use this feature. Please log in to continue.';
